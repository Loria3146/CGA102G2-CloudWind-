    ...
    $(document).ready(function () {
      ...
      for (let i = 1; i < 14; i = i + 2) {
        ...
        if (icondata == 1 || icondata == 2 || icondata == 3) {
          str += `
        <img class="icon-img" src="/CGA102G2/images/common/sun.png">  
        `;
        }
        else if (icondata == 4 || icondata == 5 || icondata == 6 || icondata == 7) {
          str += `
        <img class="icon-img" src="/CGA102G2/images/common/cloud.png">  
        `;
        } else {
          str += `
        <img class="icon-img" src="/CGA102G2/images/common/rain.png">  
        `;
        }
      }
      $(icon).append(str);
